...
Your pet can exist in several distinct health states, each with specific visual indicators and effects on your earnings:

<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
  <div className="bg-green-50 p-6 rounded-lg border border-green-200">
    <h3 className="text-xl font-semibold text-green-800 mb-2">Thriving</h3>
    <div className="grid grid-cols-2 gap-4">
      <div>
        <img src="/images/thriving-pet.png" alt="Thriving Pet State" className="rounded-lg" />
      </div>
      <div>
        <p className="mb-2"><strong>Condition:</strong> All stats above 70%</p>
        <p className="mb-2"><strong>Earnings:</strong> 3.0× base rate</p>
        <p className="mb-2"><strong>Visual Signs:</strong> Vibrant animations, bright colors, playful movements</p>
        <p><strong>Maintenance:</strong> Regular care every 2-3 hours</p>
      </div>
    </div>
  </div>
  
  <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
    <h3 className="text-xl font-semibold text-blue-800 mb-2">Healthy</h3>
    <div className="grid grid-cols-2 gap-4">
      <div>
        <img src="/images/healthy-pet.png" alt="Healthy Pet State" className="rounded-lg" />
      </div>
      <div>
        <p className="mb-2"><strong>Condition:</strong> All stats above 60%</p>
        <p className="mb-2"><strong>Earnings:</strong> 2.0× base rate</p>
        <p className="mb-2"><strong>Visual Signs:</strong> Normal animations, standard colors, regular movement</p>
        <p><strong>Maintenance:</strong> Care every 3-4 hours</p>
      </div>
    </div>
  </div>
  
  <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
    <h3 className="text-xl font-semibold text-yellow-800 mb-2">Neglected</h3>
    <div className="grid grid-cols-2 gap-4">
      <div>
        <img src="/images/neglected-pet.png" alt="Neglected Pet State" className="rounded-lg" />
      </div>
      <div>
        <p className="mb-2"><strong>Condition:</strong> One or more stats below 40%</p>
        <p className="mb-2"><strong>Earnings:</strong> 0.5× base rate (50% reduction)</p>
        <p className="mb-2"><strong>Visual Signs:</strong> Slower movements, dulled colors, occasional whining</p>
        <p><strong>Recovery:</strong> Intensive care for 3+ cycles</p>
      </div>
    </div>
  </div>
  
  <div className="bg-red-50 p-6 rounded-lg border border-red-200">
    <h3 className="text-xl font-semibold text-red-800 mb-2">Critical</h3>
    <div className="grid grid-cols-2 gap-4">
      <div>
        <img src="/images/critical-pet.png" alt="Critical Pet State" className="rounded-lg" />
      </div>
      <div>
        <p className="mb-2"><strong>Condition:</strong> One or more stats below 20%</p>
        <p className="mb-2"><strong>Earnings:</strong> 0.1× base rate (90% reduction)</p>
        <p className="mb-2"><strong>Visual Signs:</strong> Minimal movement, gray tint, distress signals</p>
        <p><strong>Recovery:</strong> Emergency intervention required</p>
      </div>
    </div>
  </div>
  
  <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
    <h3 className="text-xl font-semibold text-gray-800 mb-2">Dead</h3>
    <div className="grid grid-cols-2 gap-4">
      <div>
        <img src="/images/dead-pet.png" alt="Dead Pet State" className="rounded-lg" />
      </div>
      <div>
        <p className="mb-2"><strong>Condition:</strong> No care for 8+ hours</p>
        <p className="mb-2"><strong>Earnings:</strong> None (100% reduction)</p>
        <p className="mb-2"><strong>Visual Signs:</strong> Grayscale interface, immobile pet, "revival needed" indicator</p>
        <p><strong>Recovery:</strong> Complete revival process</p>
      </div>
    </div>
  </div>
</div>
...
<Frame caption="The revival interface guides you through the recovery process">
  <img src="/images/revival-process.png" alt="GOCHI Revival Process" />
</Frame>
...
Maintaining optimal pet health isn't just about responding to emergencies—it's about establishing sustainable care patterns:

<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
  <div className="bg-slate-50 p-6 rounded-lg">
    <h4 className="text-lg font-semibold mb-2">Preventative Care</h4>
    <ul className="list-disc pl-5">
      <li className="mb-1">Establish care routines aligned with your daily schedule</li>
      <li className="mb-1">Set regular reminders for check-ins</li>
      <li className="mb-1">Always use Sleep Mode before extended absences</li>
      <li className="mb-1">Identify your pet's "critical windows" when decay reaches thresholds</li>
      <li>Maintain stat buffers—aim for 80%+ rather than just above thresholds</li>
    </ul>
  </div>
  
  <div className="bg-slate-50 p-6 rounded-lg">
    <h4 className="text-lg font-semibold mb-2">Recovery Techniques</h4>
    <ul className="list-disc pl-5">
      <li className="mb-1">Use premium foods strategically during recovery periods</li>
      <li className="mb-1">Focus on hunger first, then address other stats</li>
      <li className="mb-1">Apply the "care cascade" approach: multiple care cycles spaced 30-60 minutes apart</li>
      <li className="mb-1">Monitor recovery progress through the status dashboard</li>
      <li>Adjust care frequency based on observed decay rates</li>
    </ul>
  </div>
</div>
