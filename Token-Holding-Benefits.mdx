...
While the holding multiplier is the primary benefit, $TOKEN tokens have additional utility:
...
<Tip>
Consider reinvesting a portion of your SOL rewards into $TOKEN tokens to gradually increase your holding multiplier over time. This strategy creates a virtuous cycle of increasing returns.
</Tip>