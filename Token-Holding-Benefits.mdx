...
description: 'How holding $PURR tokens multiplies your earning potential'
---

GOCHI's economic model includes significant benefits for token holders, creating a powerful incentive for long-term investment in the ecosystem. By holding $PURR tokens, you can dramatically increase your earning potential.
...
<Frame>
  <img src="/images/holding-multiplier.png" alt="GOCHI Holding Multiplier Curve" />
</Frame>

| Holding Tier | Token Amount | Multiplier | Effect on Rewards |
|--------------|--------------|------------|-------------------|
| Non-holder | 0 $PURR | 0.2× | -80% reward penalty |
| Basic Holder | 10,000 $PURR | 1.0× | Standard rewards (baseline) |
| Committed Holder | 100,000 $PURR | 2.0× | Double rewards |
| Significant Holder | 1,000,000 $PURR | 4.0× | Quadruple rewards |
| Whale | 10,000,000+ $PURR | 8.0× | Eight times standard rewards |
...
<AccordionGroup>
  <Accordion title="Balanced Approach">
    ...
    **Example:** 10,000 $PURR + Excellent Care (3.0×)
  ...
  <Accordion title="Token-Focused">
    ...
    **Example:** 1,000,000 $PURR + Average Care (1.0×)
  ...
  <Accordion title="Maximalist Approach">
    ...
    **Example:** 1,000,000 $PURR + Excellent Care (3.0×)
