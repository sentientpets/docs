...
GOCHI implements an 8% transaction tax on all $PURR token buy and sell transactions. This tax is the economic foundation of our sustainable care-to-earn model.

## Tax Breakdown

<Frame>
  <img src="/images/tax-allocation.png" alt="GOCHI Tax Allocation" />
</Frame>

The 8% transaction tax is allocated as follows:
...
<Steps>
  <Step title="Transaction Occurs">
    A user buys or sells $PURR tokens on a decentralized exchange.
  </Step>
...
The 2% liquidity allocation ensures market stability and depth:
...
<AccordionGroup>
  <Accordion title="Development Fund Governance">
    After the first 12 months, development fund allocation will transition to a community-governed model, where $PURR holders can vote on fund utilization.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Transaction Tax" icon="receipt-percent">
...
<Frame>
  <img src="/images/sustainability-metrics.png" alt="GOCHI Sustainability Metrics" />
</Frame>
...
<Card title="View Related Information" icon="arrow-right">
  Learn about how rewards are distributed in the [Distribution Model](/tokenomics/distribution-model) section.
</Card>