...
description: 'How pre-launch points convert to $PURR tokens at launch'
---

At the end of GOCHI's pre-launch phase, your accumulated points will be converted to $PURR tokens based on your share of the total points pool. This page explains the conversion process, allocation formula, and vesting schedule.
...
Your $PURR token allocation is calculated using this formula:
...
- `TokenAllocationPool` is 150,000,000 $PURR (15% of total supply)

<Frame>
  <img src="/images/points-conversion.png" alt="GOCHI Points Conversion Formula" />
</Frame>
...
<AccordionGroup>
  <Accordion title="Basic Example">
    ...
    **A player with 10,000 points would receive:**
    ...
    (10,000 ÷ 10,000,000) × 150,000,000 = 150,000 $PURR tokens
    
    **A player with 5,000 points would receive:**
    
    (5,000 ÷ 10,000,000) × 150,000,000 = 75,000 $PURR tokens
  </Accordion>
  
  <Accordion title="Maximum Cap Example">
    A player who reached the maximum 20,000 points cap:
    
    (20,000 ÷ 10,000,000) × 150,000,000 = 300,000 $PURR tokens
    
    However, this would be subject to the maximum allocation cap of 500,000 $PURR.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Minimum Allocation" icon="shield-check">
    Any user with at least 100 points receives a minimum of 1,000 $PURR tokens, ensuring even casual participants receive a meaningful allocation.
  </Card>
  <Card title="Maximum Allocation" icon="shield-halved">
    No single account can receive more than 500,000 $PURR tokens (0.05% of total supply), preventing excessive concentration.
  </Card>
</CardGroup>

| Protection Type | Threshold | Effect |
|-----------------|-----------|--------|
| Minimum Allocation | 100+ points | Guarantees 1,000 $PURR |
| Maximum Allocation | Formula result > 500,000 | Caps at 500,000 $PURR |
...
```mermaid
gantt
    title $PURR Token Vesting Schedule
    dateFormat  YYYY-MM-DD
    section Initial
    50% Immediate Release : milestone, 2025-01-01, 0d
    section Vesting
    Month 1 (16.7%) : 2025-01-01, 31d
    Month 2 (16.7%) : 2025-02-01, 28d
    Month 3 (16.6%) : 2025-03-01, 31d
```
...
<Table>
  <Thead>
    <Tr>
      <Th>Period</Th>
      <Th>Percentage</Th>
      <Th>For 150,000 $PURR Example</Th>
    </Tr>
  </Thead>
  <Tbody>
    <Tr>
